    ...
    <div className="mx-auto max-w-2xl space-y-6 p-4">
      ...
      {!user ? (
        ...
        <>
          ...
          {/* Ditampilkan untuk semua user login, bukan cuma owner.
              Analisis & Export memang untuk semua orang; halaman Transaksi/Jurnal
              sendiri yang membatasi tombol tambah/hapus lewat isOwner. */}
          <QuickAdd />
