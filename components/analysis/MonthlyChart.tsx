...
export default function MonthlyChart({ transactions }: { transactions: Transaction[] }) {
  ...
  return (
    <div className="bg-neutral-900 border border-neutral-800 rounded-xl p-4 space-y-4 overflow-hidden">
      ...
      <div className="flex items-end justify-center gap-6 h-40">
        <div className="flex flex-col items-center justify-end h-full min-w-0">
          ...
          <span className="text-xs text-green-400 whitespace-nowrap">{formatRupiah(income)}</span>
        </div>
        <div className="flex flex-col items-center justify-end h-full min-w-0">
          ...
          <span className="text-xs text-red-400 whitespace-nowrap">{formatRupiah(expense)}</span>
        </div>
      </div>
    </div>
  );
